...
public class Enemy_Range2 : EnemyUI
{
    ...
    [SerializeField] private GameObject projectile5;
    [SerializeField] private GameObject projectile6;
    [SerializeField] private GameObject projectile7;
    [SerializeField] private GameObject projectile8;
    [SerializeField] private GameObject projectile9;
    [SerializeField] private GameObject projectile10;
    ...
    private void Throw_2hand(float f)
    {
        ...
        int randN = Random.Range(1, 7);

        switch (randN)
        {
            case 1:
                SpawnProjectile(projectile4);
                break;
            case 2:
                SpawnProjectile(projectile5);
                break;
            case 3:
                SpawnProjectile(projectile6);
                break;
            case 4:
                SpawnProjectile(projectile7);
                break;
            case 5:
                SpawnProjectile(projectile8);
                break;
            case 6:
                SpawnProjectile(projectile9);
                break;
            case 7:
                SpawnProjectile(projectile10);
                break;
            default: break;
        };
    ...
    private void SpawnProjectile(GameObject _proj)
    {
        ...
        Quaternion qut = Quaternion.LookRotation(playerObj.transform.position - handTrans.transform.position);
        //qut.x = 0;
